...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-cash_points" class="form-control" step="0.01" name="row[cash_points]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Bonus_points'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-bonus_points" class="form-control" step="0.01" name="row[bonus_points]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Star_level'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-star_level" class="form-control" name="row[star_level]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Stockholder'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-stockholder" class="form-control" name="row[stockholder]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Locked_points'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-locked_points" class="form-control" step="0.01" name="row[locked_points]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Jackpot'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-jackpot" class="form-control" name="row[jackpot]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Register_points'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-register_points" class="form-control" step="0.01" name="row[register_points]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-first_charge" class="form-control" step="0.01" name="row[first_charge]" type="number" value="0.00">
        </div>
    </div>

...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo Form::radios('row[radio]', ['0'=>'隐藏', '1'=>'显示'], $row['status'], ['data-rule'=>'required']); ?>
        </div>
    </div>
